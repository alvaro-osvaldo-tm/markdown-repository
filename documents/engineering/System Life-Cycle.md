...
This document specifies the system life-cycle specification, is a standard life-cyle to support the operation discussions.

It's different from the [Project Life-Cycle](../management/project%20management/Project%20Life-Cycle.md) because it reflect the system and not the project.
